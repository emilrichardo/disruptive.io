             ...
             <div   className="py-16 grid grid-cols-2  gap-y-8 lg:grid-cols-4 relative">
                 <div className="text-center">
                    <svg className=" inline-block" width="60" height="66" viewBox="0 0 60 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M15.014 0.75V12.84C15.014 13.503 14.7506 14.1389 14.2818 14.6078C13.8129 15.0766 13.177 15.34 12.514 15.34H0.75" stroke="#5D5FEF" strokeWidth="1.5" stroke-linecap="round"/>
                 ...
                 <div className="text-center">
                        ...
                        <path d="M79.105 19.3099C88.799 17.3639 94.905 14.5279 94.905 11.3719V46.562C94.905 49.718 88.794 52.5539 79.105 54.4999V19.3099Z" stroke="#5D5FEF" strokeWidth="1.5" stroke-linecap="round"/>
                        <path d="M16.554 19.3099C6.86 17.3639 0.75 14.5279 0.75 11.3719V46.562C0.75 49.718 6.86 52.5539 16.55 54.4999L16.554 19.3099Z" stroke="#5D5FEF" strokeWidth="1.5" stroke-linecap="round"/>
                        <path d="M0.75 46.789V11.372C0.75 5.51 21.846 0.75 47.83 0.75C73.814 0.75 94.91 5.51 94.91 11.372V46.789M37.033 36.273C30.1656 36.7509 23.3303 37.6119 16.559 38.852M79.11 38.852C72.2858 37.593 65.3926 36.7428 58.467 36.306L79.11 38.852Z" stroke="#5D5FEF" strokeWidth="1.5" stroke-linecap="round"/>
                        <path d="M77.561 10.849C79.64 11.232 81.573 11.649 83.335 12.11M12.7 12.014C19.0965 10.5043 25.6053 9.51775 32.1619 9.06396L12.7 12.014ZM64.702 9.16396C67.796 9.43196 70.7329 9.77196 73.4729 10.175L64.702 9.16396Z" stroke="#5D5FEF" strokeWidth="1.5" stroke-linecap="round"/>
                        <path d="M65.0161 16.903C67.8481 17.154 70.5461 17.465 73.0801 17.829M22.5791 17.829C25.5631 17.4 28.7791 17.045 32.1651 16.775L22.5791 17.829Z" stroke="#5D5FEF" strokeWidth="1.5" stroke-linecap="round"/>
                        </g>
                        <defs>
