...
export default function Header() {
    return(
        <header className="px-4 py-2 fixed w-screen flex justify-between items-center z-50">
            <Logo className=" w-8"/>
            ...
            <nav className="flex items-center">
                ...
                <Button size="sm" className="hover:bg-primary py-3">
                    <div className="h-[2px] w-6 bg-light"></div>
                    <div className="h-[2px] w-6 bg-light mt-[7px]"></div>
                </Button>
            </nav>
