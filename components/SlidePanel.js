...
export default function SlidePanel({ children ,state, toggleSwitch, className}) {
    return(
        <div>
            ...
            <div className={`${className} ${state ? " right-0 ": " -right-[700px] "} transition-all duration-500  bg-dark bg-opacity-90 px-12 backdrop-blur-sm fixed w-[85%] xl:w-[85%]  max-w-[500px] xl:max-w-[500px] h-screen top-0  text-light z-30 pt-6`}>
