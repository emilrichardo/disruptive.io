...
export default function PaneleStake({panelState, panelToggleSwitch}) {
    ...
    return(
        <SlidePanel state={panelState} toggleSwitch={panelToggleSwitch}>
            <Button className="mt-2" variant="outline" size="sm">Unstake</Button>
            <div className="mt-14">
                <div className="relative">
                    <button className="w-full text-left relative"  onClick={clip}>
                        <InputForm

                        inputClassName="py-3 cursor-pointer w-full"
                        label="Mi wallet"
                        size="sm" value={walletAdress }
                        iconLeft={<svg className="mt-1" width="30" height="24" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg">
