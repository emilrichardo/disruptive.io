...
const sizes ={
    sm: 'text-sm px-2 md:px-4 py-2',
    default:' text-md px-4 md:px-8 py-3 ',
...
const variants ={
    ...
    default:' bg-light-300  hover:bg-light-200 dark:bg-dark-400 dark:hover:bg-dark-500 text-dark-200 dark:text-light-300',
