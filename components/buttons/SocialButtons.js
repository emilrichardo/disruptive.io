...
export default function SocialButtons({size}) {
    return(
        ...
        {/* <a href="/" className="hover:scale-125 transition-all">
            ...
            <a href={process.env.social.twitter} className=" mx-8  hover:scale-125 transition-all">
                <svg className={`${sizes[size] || sizes.default}`} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href={process.env.social.telegram} className="hover:scale-125 transition-all">
                <svg className={`${sizes[size] || sizes.default}`}  viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
